...
// ../shared/constants/subtitle-styles.ts
var DEFAULT_FONT = "Noto Sans";
var SUBTITLE_STYLE_PRESETS = {
  Default: {
    ...
    // Red (Often unused, copy primary or set specific if needed)
  ...
  Boxed: {
    ...
    secondaryColor: "&H000000FF",
    outlineColor: "&H00000000",
    // Black (used for Box border)
    backColor: "&H33000000",
    // More transparent black (for Box background)
    isBold: true,
    // ASS string had -1, but might look better non-bold in a box? Let's keep true for now.
    isItalic: false,
    isUnderline: false,
    isStrikeout: false,
    scaleX: 100,
    ...
    angle: 0,
    borderStyle: 4,
    // Use Style 4 for explicit box
    outlineSize: 1,
    // Outline controls box padding/border
    shadowDepth: 0,
    // Shadow controls box padding
    alignment: 2,
    // BottomCenter
    marginLeft: 10,
    marginRight: 10,
    marginVertical: 15,
    // Adjust if needed for box
    encoding: 1
  },
  Classic: {
    name: "Classic",
  ...
  LineBox: {
    ...
    angle: 0,
    borderStyle: 3,
    // Keep as opaque box concept
    outlineSize: 0,
    shadowDepth: 0,
    // No shadow offset needed for box
    alignment: 2,
    // BottomCenter
    marginLeft: 10,
    marginRight: 10,
...
var PRICE_MARGIN = 2;
var GPT4_1_USD_PER_TOKEN_IN = 2 / 1e6;
var GPT4_1_USD_PER_TOKEN_OUT = 8 / 1e6;
var TOKEN_CREDIT_CALIBRATION_UI = 0.7;
var CREDITS_PER_1K_TOKENS_PROMPT = Math.ceil(
  PRICE_MARGIN * 1e3 * GPT4_1_USD_PER_TOKEN_IN / USD_PER_CREDIT * TOKEN_CREDIT_CALIBRATION_UI
);
var CREDITS_PER_1K_TOKENS_COMPLETION = Math.ceil(
  PRICE_MARGIN * 1e3 * GPT4_1_USD_PER_TOKEN_OUT / USD_PER_CREDIT * TOKEN_CREDIT_CALIBRATION_UI
);
...
var TRANSLATION_REVIEW_OVERHEAD_MULTIPLIER = 3.06;
...
var WHISPER_TURBO_USD_PER_HOUR = 0.04;
var CREDITS_PER_TRANSCRIPTION_AUDIO_HOUR = Math.ceil(
  PRICE_MARGIN * WHISPER_TURBO_USD_PER_HOUR / USD_PER_CREDIT * 0.3
);
var CREDITS_PER_AUDIO_HOUR = CREDITS_PER_TRANSCRIPTION_AUDIO_HOUR;
var CREDITS_PER_AUDIO_SECOND = CREDITS_PER_AUDIO_HOUR / 3600;
var MICRO_CREDITS = 15e3;
