...
import { SubtitleProcessing } from "./subtitle-processing";
...
export function setupIpcHandlers(): void {
  try {
    ...
    if (!isHandlerRegistered("ping")) {
      log.info("Registering ping handler in ipc-handlers");
      ipcMain.handle("ping", () => {
      ...
      ipcMain.handle(
        ...
        async (
          ...
          try {
            ...
            const filePath = await fileManager.saveFile(options.content, {
