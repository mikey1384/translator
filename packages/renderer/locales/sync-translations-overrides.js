...
const videoSuggestionContextOverrides = {
  "af": {
    ...
    "input.videoSuggestion.includeDownloadHistoryLabel": "Sluit my aflaaigeskiedenis in",
    "input.videoSuggestion.includeDownloadHistoryHint": "Laat KI jou onlangse afgelaaide videotitels as sagte konteks gebruik vir beter voorstelle.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Sluit my gekykte kanale in",
    "input.videoSuggestion.includeWatchedChannelsHint": "Laat KI jou onlangse kanaalgeskiedenis as sagte konteks gebruik vir beter voorstelle.",
    "input.videoSuggestion.followUp.moreFromHistory": "Nog video's soos \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Video's van kanale soos {{channel}}"
  },
  "ar": {
    ...
    "input.videoSuggestion.includeDownloadHistoryLabel": "أدرج سجل التنزيلات الخاص بي",
    "input.videoSuggestion.includeDownloadHistoryHint": "اسمح للذكاء الاصطناعي باستخدام عناوين الفيديوهات التي نزّلتها مؤخرًا كسياق خفيف لتحسين الاقتراحات.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "أدرج القنوات التي شاهدتها",
    "input.videoSuggestion.includeWatchedChannelsHint": "اسمح للذكاء الاصطناعي باستخدام سجل القنوات الأخير كسياق خفيف لتحسين الاقتراحات.",
    "input.videoSuggestion.followUp.moreFromHistory": "المزيد من الفيديوهات مثل \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "فيديوهات من قنوات مثل {{channel}}"
  },
  "bn": {
    ...
    "input.videoSuggestion.includeDownloadHistoryLabel": "আমার ডাউনলোড ইতিহাস অন্তর্ভুক্ত করুন",
    "input.videoSuggestion.includeDownloadHistoryHint": "আরও ভালো পরামর্শের জন্য AI-কে আপনার সাম্প্রতিক ডাউনলোড করা ভিডিওর শিরোনামগুলো হালকা প্রসঙ্গ হিসেবে ব্যবহার করতে দিন।",
    "input.videoSuggestion.includeWatchedChannelsLabel": "আমি যেসব চ্যানেল দেখেছি সেগুলো অন্তর্ভুক্ত করুন",
    "input.videoSuggestion.includeWatchedChannelsHint": "আরও ভালো পরামর্শের জন্য AI-কে আপনার সাম্প্রতিক চ্যানেল ইতিহাস হালকা প্রসঙ্গ হিসেবে ব্যবহার করতে দিন।",
    "input.videoSuggestion.followUp.moreFromHistory": "\"{{title}}\"-এর মতো আরও ভিডিও",
    "input.videoSuggestion.followUp.channelFromHistory": "{{channel}}-এর মতো চ্যানেল থেকে ভিডিও"
  },
  "cs": {
    "input.videoSuggestion.savedToFolder": "Uloženo do vaší složky",
    "input.videoSuggestion.tempFileAvailable": "Dočasná kopie je stále k dispozici",
    "input.videoSuggestion.localFileAvailable": "Soubor je k dispozici",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Zahrnout mou historii stahování",
    "input.videoSuggestion.includeDownloadHistoryHint": "Povol AI používat názvy vašich nedávno stažených videí jako lehký kontext pro lepší návrhy.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Zahrnout kanály, které sleduji",
    "input.videoSuggestion.includeWatchedChannelsHint": "Povol AI používat vaši nedávnou historii kanálů jako lehký kontext pro lepší návrhy.",
    "input.videoSuggestion.followUp.moreFromHistory": "Další videa jako \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Videa z kanálů jako {{channel}}"
  },
  "da": {
    "input.videoSuggestion.savedToFolder": "Gemt i din mappe",
    "input.videoSuggestion.tempFileAvailable": "Midlertidig kopi er stadig tilgængelig",
    "input.videoSuggestion.localFileAvailable": "Fil tilgængelig",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Medtag min downloadhistorik",
    "input.videoSuggestion.includeDownloadHistoryHint": "Lad AI bruge titlerne på dine nyligt downloadede videoer som blød kontekst til bedre forslag.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Medtag mine sete kanaler",
    "input.videoSuggestion.includeWatchedChannelsHint": "Lad AI bruge din seneste kanalhistorik som blød kontekst til bedre forslag.",
    "input.videoSuggestion.followUp.moreFromHistory": "Flere videoer som \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Videoer fra kanaler som {{channel}}"
  },
  "de": {
    ...
    "input.videoSuggestion.includeDownloadHistoryLabel": "Meinen Downloadverlauf einbeziehen",
    "input.videoSuggestion.includeDownloadHistoryHint": "Lass die KI die Titel deiner zuletzt heruntergeladenen Videos als weichen Kontext für bessere Vorschläge nutzen.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Meine angesehenen Kanäle einbeziehen",
    "input.videoSuggestion.includeWatchedChannelsHint": "Lass die KI deinen jüngsten Kanalverlauf als weichen Kontext für bessere Vorschläge nutzen.",
    "input.videoSuggestion.followUp.moreFromHistory": "Mehr Videos wie \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Videos von Kanälen wie {{channel}}"
  },
  "el": {
    "input.videoSuggestion.savedToFolder": "Αποθηκεύτηκε στον φάκελό σας",
    "input.videoSuggestion.tempFileAvailable": "Το προσωρινό αντίγραφο είναι ακόμη διαθέσιμο",
    "input.videoSuggestion.localFileAvailable": "Το αρχείο είναι διαθέσιμο",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Συμπερίληψη του ιστορικού λήψεών μου",
    "input.videoSuggestion.includeDownloadHistoryHint": "Άφησε την AI να χρησιμοποιεί τους τίτλους των πρόσφατα κατεβασμένων βίντεό σου ως ελαφρύ πλαίσιο για καλύτερες προτάσεις.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Συμπερίληψη των καναλιών που παρακολουθώ",
    "input.videoSuggestion.includeWatchedChannelsHint": "Άφησε την AI να χρησιμοποιεί το πρόσφατο ιστορικό καναλιών σου ως ελαφρύ πλαίσιο για καλύτερες προτάσεις.",
    "input.videoSuggestion.followUp.moreFromHistory": "Περισσότερα βίντεο σαν το \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Βίντεο από κανάλια σαν το {{channel}}"
  },
  "es": {
    "input.videoSuggestion.savedToFolder": "Guardado en tu carpeta",
    "input.videoSuggestion.tempFileAvailable": "La copia temporal sigue disponible",
    "input.videoSuggestion.localFileAvailable": "Archivo disponible",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Incluir mi historial de descargas",
    "input.videoSuggestion.includeDownloadHistoryHint": "Deja que la IA use los títulos de tus videos descargados recientemente como contexto suave para mejores sugerencias.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Incluir mis canales vistos",
    "input.videoSuggestion.includeWatchedChannelsHint": "Deja que la IA use tu historial reciente de canales como contexto suave para mejores sugerencias.",
    "input.videoSuggestion.followUp.moreFromHistory": "Más videos como \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Videos de canales como {{channel}}"
  },
  "fa": {
    ...
    "input.videoSuggestion.includeDownloadHistoryLabel": "تاریخچهٔ دانلود من را هم لحاظ کن",
    "input.videoSuggestion.includeDownloadHistoryHint": "اجازه بده AI عنوان ویدیوهای دانلودشدهٔ اخیر شما را به‌عنوان زمینهٔ سبک برای پیشنهادهای بهتر استفاده کند.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "کانال‌هایی که دیده‌ام را هم لحاظ کن",
    "input.videoSuggestion.includeWatchedChannelsHint": "اجازه بده AI تاریخچهٔ اخیر کانال‌های شما را به‌عنوان زمینهٔ سبک برای پیشنهادهای بهتر استفاده کند.",
    "input.videoSuggestion.followUp.moreFromHistory": "ویدیوهای بیشتری مثل \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "ویدیوهایی از کانال‌هایی مثل {{channel}}"
  },
  "fi": {
    "input.videoSuggestion.savedToFolder": "Tallennettu kansioosi",
    "input.videoSuggestion.tempFileAvailable": "Väliaikainen kopio on yhä saatavilla",
    "input.videoSuggestion.localFileAvailable": "Tiedosto saatavilla",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Sisällytä lataushistoriani",
    "input.videoSuggestion.includeDownloadHistoryHint": "Anna tekoälyn käyttää viimeksi lataamiesi videoiden otsikoita kevyenä kontekstina parempia ehdotuksia varten.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Sisällytä katsomani kanavat",
    "input.videoSuggestion.includeWatchedChannelsHint": "Anna tekoälyn käyttää viimeaikaista kanavahistoriaasi kevyenä kontekstina parempia ehdotuksia varten.",
    "input.videoSuggestion.followUp.moreFromHistory": "Lisää videoita kuten \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Videoita kanavilta kuten {{channel}}"
  },
  "fr": {
    "input.videoSuggestion.savedToFolder": "Enregistré dans votre dossier",
    "input.videoSuggestion.tempFileAvailable": "La copie temporaire est toujours disponible",
    "input.videoSuggestion.localFileAvailable": "Fichier disponible",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Inclure mon historique de téléchargements",
    "input.videoSuggestion.includeDownloadHistoryHint": "Laissez l’IA utiliser les titres de vos vidéos récemment téléchargées comme contexte léger pour de meilleures suggestions.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Inclure les chaînes que j’ai regardées",
    "input.videoSuggestion.includeWatchedChannelsHint": "Laissez l’IA utiliser l’historique récent de vos chaînes comme contexte léger pour de meilleures suggestions.",
    "input.videoSuggestion.followUp.moreFromHistory": "Plus de vidéos comme \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Des vidéos de chaînes comme {{channel}}"
  },
  "he": {
    ...
    "input.videoSuggestion.includeDownloadHistoryLabel": "כלול את היסטוריית ההורדות שלי",
    "input.videoSuggestion.includeDownloadHistoryHint": "אפשר ל-AI להשתמש בכותרות הסרטונים שהורדת לאחרונה כהקשר קל להצעות טובות יותר.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "כלול את הערוצים שצפיתי בהם",
    "input.videoSuggestion.includeWatchedChannelsHint": "אפשר ל-AI להשתמש בהיסטוריית הערוצים האחרונה שלך כהקשר קל להצעות טובות יותר.",
    "input.videoSuggestion.followUp.moreFromHistory": "עוד סרטונים כמו \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "סרטונים מערוצים כמו {{channel}}"
  },
  "hi": {
    ...
    "input.videoSuggestion.includeDownloadHistoryLabel": "मेरा डाउनलोड इतिहास शामिल करें",
    "input.videoSuggestion.includeDownloadHistoryHint": "बेहतर सुझावों के लिए AI को हाल ही में डाउनलोड किए गए वीडियो शीर्षकों को हल्के संदर्भ के रूप में इस्तेमाल करने दें।",
    "input.videoSuggestion.includeWatchedChannelsLabel": "मेरे देखे गए चैनल शामिल करें",
    "input.videoSuggestion.includeWatchedChannelsHint": "बेहतर सुझावों के लिए AI को आपके हाल के चैनल इतिहास को हल्के संदर्भ के रूप में इस्तेमाल करने दें।",
    "input.videoSuggestion.followUp.moreFromHistory": "\"{{title}}\" जैसे और वीडियो",
    "input.videoSuggestion.followUp.channelFromHistory": "{{channel}} जैसे चैनलों के वीडियो"
  },
  "hu": {
    "input.videoSuggestion.savedToFolder": "A mappádba mentve",
    "input.videoSuggestion.tempFileAvailable": "Az ideiglenes másolat még elérhető",
    "input.videoSuggestion.localFileAvailable": "Fájl elérhető",
    "input.videoSuggestion.includeDownloadHistoryLabel": "A letöltési előzményeim belefoglalása",
    "input.videoSuggestion.includeDownloadHistoryHint": "Engedd, hogy az AI a nemrég letöltött videóid címeit laza kontextusként használja jobb javaslatokhoz.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "A megtekintett csatornáim belefoglalása",
    "input.videoSuggestion.includeWatchedChannelsHint": "Engedd, hogy az AI a friss csatornaelőzményeidet laza kontextusként használja jobb javaslatokhoz.",
    "input.videoSuggestion.followUp.moreFromHistory": "Több videó, mint \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Videók olyan csatornáktól, mint {{channel}}"
  },
  "id": {
    "input.videoSuggestion.savedToFolder": "Disimpan ke folder Anda",
    "input.videoSuggestion.tempFileAvailable": "Salinan sementara masih tersedia",
    "input.videoSuggestion.localFileAvailable": "File tersedia",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Sertakan riwayat unduhan saya",
    "input.videoSuggestion.includeDownloadHistoryHint": "Biarkan AI menggunakan judul video yang baru Anda unduh sebagai konteks ringan untuk saran yang lebih baik.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Sertakan channel yang saya tonton",
    "input.videoSuggestion.includeWatchedChannelsHint": "Biarkan AI menggunakan riwayat channel terbaru Anda sebagai konteks ringan untuk saran yang lebih baik.",
    "input.videoSuggestion.followUp.moreFromHistory": "Lebih banyak video seperti \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Video dari channel seperti {{channel}}"
  },
  "it": {
    "input.videoSuggestion.savedToFolder": "Salvato nella tua cartella",
    "input.videoSuggestion.tempFileAvailable": "La copia temporanea è ancora disponibile",
    "input.videoSuggestion.localFileAvailable": "File disponibile",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Includi la mia cronologia dei download",
    "input.videoSuggestion.includeDownloadHistoryHint": "Consenti all'AI di usare i titoli dei video scaricati di recente come contesto leggero per suggerimenti migliori.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Includi i canali che ho guardato",
    "input.videoSuggestion.includeWatchedChannelsHint": "Consenti all'AI di usare la tua cronologia recente dei canali come contesto leggero per suggerimenti migliori.",
    "input.videoSuggestion.followUp.moreFromHistory": "Altri video come \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Video da canali come {{channel}}"
  },
  "ja": {
    ...
    "input.videoSuggestion.includeDownloadHistoryLabel": "自分のダウンロード履歴を含める",
    "input.videoSuggestion.includeDownloadHistoryHint": "より良い提案のために、最近ダウンロードした動画タイトルをAIが軽い文脈として使えるようにします。",
    "input.videoSuggestion.includeWatchedChannelsLabel": "自分が見たチャンネルを含める",
    "input.videoSuggestion.includeWatchedChannelsHint": "より良い提案のために、最近のチャンネル履歴をAIが軽い文脈として使えるようにします。",
    "input.videoSuggestion.followUp.moreFromHistory": "\"{{title}}\" のような動画をもっと見る",
    "input.videoSuggestion.followUp.channelFromHistory": "{{channel}} のようなチャンネルの動画"
  },
  "ko": {
    ...
    "input.videoSuggestion.includeDownloadHistoryLabel": "내 다운로드 기록 포함",
    "input.videoSuggestion.includeDownloadHistoryHint": "더 나은 추천을 위해 최근 다운로드한 비디오 제목을 AI가 가벼운 문맥으로 활용하도록 합니다.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "내가 본 채널 포함",
    "input.videoSuggestion.includeWatchedChannelsHint": "더 나은 추천을 위해 최근 채널 기록을 AI가 가벼운 문맥으로 활용하도록 합니다.",
    "input.videoSuggestion.followUp.moreFromHistory": "\"{{title}}\" 같은 영상 더 보기",
    "input.videoSuggestion.followUp.channelFromHistory": "{{channel}} 같은 채널의 영상"
  },
  "mr": {
    ...
    "input.videoSuggestion.includeDownloadHistoryLabel": "माझा डाउनलोड इतिहास समाविष्ट करा",
    "input.videoSuggestion.includeDownloadHistoryHint": "चांगल्या सूचनांसाठी AI ला अलीकडे डाउनलोड केलेल्या व्हिडिओंची शीर्षके हलक्या संदर्भ म्हणून वापरू द्या.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "मी पाहिलेले चॅनेल समाविष्ट करा",
    "input.videoSuggestion.includeWatchedChannelsHint": "चांगल्या सूचनांसाठी AI ला तुमचा अलीकडचा चॅनेल इतिहास हलक्या संदर्भ म्हणून वापरू द्या.",
    "input.videoSuggestion.followUp.moreFromHistory": "\"{{title}}\" सारखे आणखी व्हिडिओ",
    "input.videoSuggestion.followUp.channelFromHistory": "{{channel}} सारख्या चॅनेलमधील व्हिडिओ"
  },
  "ms": {
    "input.videoSuggestion.savedToFolder": "Disimpan ke folder anda",
    "input.videoSuggestion.tempFileAvailable": "Salinan sementara masih tersedia",
    "input.videoSuggestion.localFileAvailable": "Fail tersedia",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Sertakan sejarah muat turun saya",
    "input.videoSuggestion.includeDownloadHistoryHint": "Benarkan AI menggunakan tajuk video yang anda muat turun baru-baru ini sebagai konteks ringan untuk cadangan yang lebih baik.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Sertakan saluran yang saya tonton",
    "input.videoSuggestion.includeWatchedChannelsHint": "Benarkan AI menggunakan sejarah saluran terbaru anda sebagai konteks ringan untuk cadangan yang lebih baik.",
    "input.videoSuggestion.followUp.moreFromHistory": "Lebih banyak video seperti \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Video daripada saluran seperti {{channel}}"
  },
  "nl": {
    "input.videoSuggestion.savedToFolder": "Opgeslagen in je map",
    "input.videoSuggestion.tempFileAvailable": "Tijdelijke kopie nog beschikbaar",
    "input.videoSuggestion.localFileAvailable": "Bestand beschikbaar",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Mijn downloadgeschiedenis meenemen",
    "input.videoSuggestion.includeDownloadHistoryHint": "Laat AI de titels van je recent gedownloade video's gebruiken als lichte context voor betere suggesties.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Mijn bekeken kanalen meenemen",
    "input.videoSuggestion.includeWatchedChannelsHint": "Laat AI je recente kanaalgeschiedenis gebruiken als lichte context voor betere suggesties.",
    "input.videoSuggestion.followUp.moreFromHistory": "Meer video's zoals \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Video's van kanalen zoals {{channel}}"
  },
  "no": {
    "input.videoSuggestion.savedToFolder": "Lagret i mappen din",
    "input.videoSuggestion.tempFileAvailable": "Midlertidig kopi er fortsatt tilgjengelig",
    "input.videoSuggestion.localFileAvailable": "Fil tilgjengelig",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Ta med nedlastingshistorikken min",
    "input.videoSuggestion.includeDownloadHistoryHint": "La AI bruke titlene på nylig nedlastede videoer som lett kontekst for bedre forslag.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Ta med kanalene jeg har sett",
    "input.videoSuggestion.includeWatchedChannelsHint": "La AI bruke den siste kanalhistorikken din som lett kontekst for bedre forslag.",
    "input.videoSuggestion.followUp.moreFromHistory": "Flere videoer som \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Videoer fra kanaler som {{channel}}"
  },
  "pl": {
    "input.videoSuggestion.savedToFolder": "Zapisano w twoim folderze",
    "input.videoSuggestion.tempFileAvailable": "Tymczasowa kopia jest nadal dostępna",
    "input.videoSuggestion.localFileAvailable": "Plik jest dostępny",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Uwzględnij moją historię pobierania",
    "input.videoSuggestion.includeDownloadHistoryHint": "Pozwól AI używać tytułów ostatnio pobranych filmów jako lekkiego kontekstu do lepszych sugestii.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Uwzględnij oglądane przeze mnie kanały",
    "input.videoSuggestion.includeWatchedChannelsHint": "Pozwól AI używać twojej ostatniej historii kanałów jako lekkiego kontekstu do lepszych sugestii.",
    "input.videoSuggestion.followUp.moreFromHistory": "Więcej filmów takich jak \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Filmy z kanałów takich jak {{channel}}"
  },
  "pt": {
    "input.videoSuggestion.savedToFolder": "Salvo na sua pasta",
    "input.videoSuggestion.tempFileAvailable": "A cópia temporária ainda está disponível",
    "input.videoSuggestion.localFileAvailable": "Arquivo disponível",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Incluir meu histórico de downloads",
    "input.videoSuggestion.includeDownloadHistoryHint": "Permita que a IA use os títulos dos vídeos baixados recentemente como contexto leve para sugestões melhores.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Incluir os canais que assisti",
    "input.videoSuggestion.includeWatchedChannelsHint": "Permita que a IA use seu histórico recente de canais como contexto leve para sugestões melhores.",
    "input.videoSuggestion.followUp.moreFromHistory": "Mais vídeos como \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Vídeos de canais como {{channel}}"
  },
  "ro": {
    "input.videoSuggestion.savedToFolder": "Salvat în folderul tău",
    "input.videoSuggestion.tempFileAvailable": "Copia temporară este încă disponibilă",
    "input.videoSuggestion.localFileAvailable": "Fișier disponibil",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Include istoricul meu de descărcări",
    "input.videoSuggestion.includeDownloadHistoryHint": "Lasă AI-ul să folosească titlurile videoclipurilor descărcate recent ca context ușor pentru sugestii mai bune.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Include canalele pe care le-am urmărit",
    "input.videoSuggestion.includeWatchedChannelsHint": "Lasă AI-ul să folosească istoricul tău recent de canale ca context ușor pentru sugestii mai bune.",
    "input.videoSuggestion.followUp.moreFromHistory": "Mai multe videoclipuri precum \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Videoclipuri de la canale precum {{channel}}"
  },
  "ru": {
    "input.videoSuggestion.savedToFolder": "Сохранено в вашу папку",
    "input.videoSuggestion.tempFileAvailable": "Временная копия всё ещё доступна",
    "input.videoSuggestion.localFileAvailable": "Файл доступен",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Включить мою историю загрузок",
    "input.videoSuggestion.includeDownloadHistoryHint": "Разрешить ИИ использовать названия недавно загруженных видео как лёгкий контекст для лучших рекомендаций.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Включить каналы, которые я смотрел",
    "input.videoSuggestion.includeWatchedChannelsHint": "Разрешить ИИ использовать вашу недавнюю историю каналов как лёгкий контекст для лучших рекомендаций.",
    "input.videoSuggestion.followUp.moreFromHistory": "Больше видео вроде \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Видео с каналов вроде {{channel}}"
  },
  "sv": {
    "input.videoSuggestion.savedToFolder": "Sparad i din mapp",
    "input.videoSuggestion.tempFileAvailable": "Tillfällig kopia finns fortfarande kvar",
    "input.videoSuggestion.localFileAvailable": "Fil tillgänglig",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Inkludera min nedladdningshistorik",
    "input.videoSuggestion.includeDownloadHistoryHint": "Låt AI använda titlarna på dina nyligen nedladdade videor som lätt kontext för bättre förslag.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Inkludera mina tittade kanaler",
    "input.videoSuggestion.includeWatchedChannelsHint": "Låt AI använda din senaste kanalhistorik som lätt kontext för bättre förslag.",
    "input.videoSuggestion.followUp.moreFromHistory": "Fler videor som \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Videor från kanaler som {{channel}}"
  },
  "sw": {
    "input.videoSuggestion.savedToFolder": "Imehifadhiwa kwenye folda yako",
    "input.videoSuggestion.tempFileAvailable": "Nakala ya muda bado inapatikana",
    "input.videoSuggestion.localFileAvailable": "Faili inapatikana",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Jumuisha historia yangu ya upakuaji",
    "input.videoSuggestion.includeDownloadHistoryHint": "Ruhusu AI itumie majina ya video ulizopakua hivi karibuni kama muktadha mwepesi kwa mapendekezo bora.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Jumuisha vituo nilivyotazama",
    "input.videoSuggestion.includeWatchedChannelsHint": "Ruhusu AI itumie historia yako ya hivi karibuni ya vituo kama muktadha mwepesi kwa mapendekezo bora.",
    "input.videoSuggestion.followUp.moreFromHistory": "Video zaidi kama \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Video kutoka vituo kama {{channel}}"
  },
  "ta": {
    "input.videoSuggestion.savedToFolder": "உங்கள் கோப்புறையில் சேமிக்கப்பட்டது",
    "input.videoSuggestion.tempFileAvailable": "தற்காலிக நகல் இன்னும் கிடைக்கிறது",
    "input.videoSuggestion.localFileAvailable": "கோப்பு கிடைக்கிறது",
    "input.videoSuggestion.includeDownloadHistoryLabel": "என் பதிவிறக்க வரலாற்றை சேர்க்கவும்",
    "input.videoSuggestion.includeDownloadHistoryHint": "சிறந்த பரிந்துரைகளுக்காக நீங்கள் சமீபத்தில் பதிவிறக்கிய வீடியோ தலைப்புகளை AI மென்மையான சூழலாக பயன்படுத்த அனுமதிக்கவும்.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "நான் பார்த்த சேனல்களை சேர்க்கவும்",
    "input.videoSuggestion.includeWatchedChannelsHint": "சிறந்த பரிந்துரைகளுக்காக உங்கள் சமீபத்திய சேனல் வரலாற்றை AI மென்மையான சூழலாக பயன்படுத்த அனுமதிக்கவும்.",
    "input.videoSuggestion.followUp.moreFromHistory": "\"{{title}}\" போன்ற மேலும் வீடியோக்கள்",
    "input.videoSuggestion.followUp.channelFromHistory": "{{channel}} போன்ற சேனல்களிலிருந்து வீடியோக்கள்"
  },
  "te": {
    "input.videoSuggestion.savedToFolder": "మీ ఫోల్డర్‌లో సేవ్ అయింది",
    "input.videoSuggestion.tempFileAvailable": "తాత్కాలిక కాపీ ఇంకా అందుబాటులో ఉంది",
    "input.videoSuggestion.localFileAvailable": "ఫైల్ అందుబాటులో ఉంది",
    "input.videoSuggestion.includeDownloadHistoryLabel": "నా డౌన్‌లోడ్ చరిత్రను చేర్చు",
    "input.videoSuggestion.includeDownloadHistoryHint": "మెరుగైన సూచనల కోసం ఇటీవల డౌన్‌లోడ్ చేసిన వీడియో శీర్షికలను AI తేలికపాటి సందర్భంగా ఉపయోగించనివ్వండి.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "నేను చూసిన ఛానళ్లను చేర్చు",
    "input.videoSuggestion.includeWatchedChannelsHint": "మెరుగైన సూచనల కోసం మీ ఇటీవలి ఛానల్ చరిత్రను AI తేలికపాటి సందర్భంగా ఉపయోగించనివ్వండి.",
    "input.videoSuggestion.followUp.moreFromHistory": "\"{{title}}\" లాంటి మరిన్ని వీడియోలు",
    "input.videoSuggestion.followUp.channelFromHistory": "{{channel}}లాంటి ఛానళ్ల నుండి వీడియోలు"
  },
  "th": {
    ...
    "input.videoSuggestion.includeDownloadHistoryLabel": "รวมประวัติการดาวน์โหลดของฉัน",
    "input.videoSuggestion.includeDownloadHistoryHint": "ให้ AI ใช้ชื่อวิดีโอที่คุณเพิ่งดาวน์โหลดเป็นบริบทแบบเบา ๆ เพื่อให้คำแนะนำดีขึ้น",
    "input.videoSuggestion.includeWatchedChannelsLabel": "รวมช่องที่ฉันเคยดู",
    "input.videoSuggestion.includeWatchedChannelsHint": "ให้ AI ใช้ประวัติช่องล่าสุดของคุณเป็นบริบทแบบเบา ๆ เพื่อให้คำแนะนำดีขึ้น",
    "input.videoSuggestion.followUp.moreFromHistory": "วิดีโอเพิ่มเติมแบบ \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "วิดีโอจากช่องแบบ {{channel}}"
  },
  "tl": {
    ...
    "input.videoSuggestion.includeDownloadHistoryLabel": "Isama ang history ng mga download ko",
    "input.videoSuggestion.includeDownloadHistoryHint": "Payagan ang AI na gamitin ang mga pamagat ng mga video na na-download mo kamakailan bilang magaan na konteksto para sa mas magandang mungkahi.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Isama ang mga channel na pinanood ko",
    "input.videoSuggestion.includeWatchedChannelsHint": "Payagan ang AI na gamitin ang kamakailan mong history ng mga channel bilang magaan na konteksto para sa mas magandang mungkahi.",
    "input.videoSuggestion.followUp.moreFromHistory": "Mas maraming video na tulad ng \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Mga video mula sa mga channel na tulad ng {{channel}}"
  },
  "tr": {
    "input.videoSuggestion.savedToFolder": "Klasörünüze kaydedildi",
    "input.videoSuggestion.tempFileAvailable": "Geçici kopya hâlâ kullanılabilir",
    "input.videoSuggestion.localFileAvailable": "Dosya kullanılabilir",
    "input.videoSuggestion.includeDownloadHistoryLabel": "İndirme geçmişimi dahil et",
    "input.videoSuggestion.includeDownloadHistoryHint": "Daha iyi öneriler için AI'nin son indirilen video başlıklarınızı hafif bağlam olarak kullanmasına izin verin.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "İzlediğim kanalları dahil et",
    "input.videoSuggestion.includeWatchedChannelsHint": "Daha iyi öneriler için AI'nin son kanal geçmişinizi hafif bağlam olarak kullanmasına izin verin.",
    "input.videoSuggestion.followUp.moreFromHistory": "\"{{title}}\" gibi daha fazla video",
    "input.videoSuggestion.followUp.channelFromHistory": "{{channel}} gibi kanallardan videolar"
  },
  "uk": {
    "input.videoSuggestion.savedToFolder": "Збережено у вашу папку",
    "input.videoSuggestion.tempFileAvailable": "Тимчасова копія все ще доступна",
    "input.videoSuggestion.localFileAvailable": "Файл доступний",
    "input.videoSuggestion.includeDownloadHistoryLabel": "Додати мою історію завантажень",
    "input.videoSuggestion.includeDownloadHistoryHint": "Дозволь ШІ використовувати назви нещодавно завантажених відео як легкий контекст для кращих рекомендацій.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Додати канали, які я дивився",
    "input.videoSuggestion.includeWatchedChannelsHint": "Дозволь ШІ використовувати вашу недавню історію каналів як легкий контекст для кращих рекомендацій.",
    "input.videoSuggestion.followUp.moreFromHistory": "Більше відео на кшталт \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Відео з каналів на кшталт {{channel}}"
  },
  "ur": {
    ...
    "input.videoSuggestion.includeDownloadHistoryLabel": "میری ڈاؤن لوڈ ہسٹری شامل کریں",
    "input.videoSuggestion.includeDownloadHistoryHint": "بہتر تجاویز کے لیے AI کو آپ کی حال ہی میں ڈاؤن لوڈ کی گئی ویڈیوز کے عنوانات ہلکے سیاق کے طور پر استعمال کرنے دیں۔",
    "input.videoSuggestion.includeWatchedChannelsLabel": "میں نے جو چینلز دیکھے ہیں انہیں شامل کریں",
    "input.videoSuggestion.includeWatchedChannelsHint": "بہتر تجاویز کے لیے AI کو آپ کی حالیہ چینل ہسٹری ہلکے سیاق کے طور پر استعمال کرنے دیں۔",
    "input.videoSuggestion.followUp.moreFromHistory": "\"{{title}}\" جیسی مزید ویڈیوز",
    "input.videoSuggestion.followUp.channelFromHistory": "{{channel}} جیسے چینلز کی ویڈیوز"
  },
  "vi": {
    ...
    "input.videoSuggestion.includeDownloadHistoryLabel": "Bao gồm lịch sử tải xuống của tôi",
    "input.videoSuggestion.includeDownloadHistoryHint": "Cho phép AI dùng tiêu đề các video bạn tải xuống gần đây làm ngữ cảnh nhẹ để gợi ý tốt hơn.",
    "input.videoSuggestion.includeWatchedChannelsLabel": "Bao gồm các kênh tôi đã xem",
    "input.videoSuggestion.includeWatchedChannelsHint": "Cho phép AI dùng lịch sử kênh gần đây của bạn làm ngữ cảnh nhẹ để gợi ý tốt hơn.",
    "input.videoSuggestion.followUp.moreFromHistory": "Thêm video giống \"{{title}}\"",
    "input.videoSuggestion.followUp.channelFromHistory": "Video từ các kênh như {{channel}}"
  },
  "zh-CN": {
    ...
    "input.videoSuggestion.includeDownloadHistoryHint": "让 AI 使用你最近下载过的视频标题作为轻量上下文，以获得更好的推荐。",
    "input.videoSuggestion.includeWatchedChannelsLabel": "包含我看过的频道",
    "input.videoSuggestion.includeWatchedChannelsHint": "让 AI 使用你最近的频道历史作为轻量上下文，以获得更好的推荐。",
    "input.videoSuggestion.followUp.moreFromHistory": "更多像 \"{{title}}\" 这样的视频",
    "input.videoSuggestion.followUp.channelFromHistory": "来自像 {{channel}} 这样频道的视频"
  },
  "zh-TW": {
    ...
    "input.videoSuggestion.includeDownloadHistoryHint": "讓 AI 使用你最近下載過的影片標題作為輕量上下文，以獲得更好的推薦。",
    "input.videoSuggestion.includeWatchedChannelsLabel": "包含我看過的頻道",
    "input.videoSuggestion.includeWatchedChannelsHint": "讓 AI 使用你最近的頻道歷史作為輕量上下文，以獲得更好的推薦。",
    "input.videoSuggestion.followUp.moreFromHistory": "更多像 \"{{title}}\" 這樣的影片",
    "input.videoSuggestion.followUp.channelFromHistory": "來自像 {{channel}} 這樣頻道的影片"
  }
};
