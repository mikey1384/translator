...
const downloadHistoryStorageKeys = [
  'deleteLocalFile',
...
].map(key => `input.videoSuggestion.${key}`);

function buildDownloadHistoryStorageOverrides(values) {
  if (values.length !== downloadHistoryStorageKeys.length) {
    throw new Error('Download history storage translations are incomplete.');
  }
  return Object.fromEntries(
    downloadHistoryStorageKeys.map((key, index) => [key, values[index]])
  );
}

const downloadHistoryStorageOverrides = {
  af: buildDownloadHistoryStorageOverrides([
    'Vee lêer van toestel uit',
    'Vee hierdie afgelaaide lêer permanent van hierdie toestel uit? Die geskiedenisinskrywing en bronskakel sal behoue bly.',
    'Die afgelaaide lêer kon nie van hierdie toestel uitgevee word nie.',
    'Hierdie aflaai het nie meer ’n uitveebare lêer in die toepassingbiblioteek nie.',
    'Hierdie video is tans oop. Maak ’n ander video oop voordat jy dit uitvee.',
    'Vee lêer en geskiedenis uit',
    'Vee hierdie afgelaaide lêer permanent uit en verwyder die geskiedenisinskrywing? Dit kan nie ongedaan gemaak word nie.',
    'Verwyder uit geskiedenis',
    'Verwyder hierdie item uit die aflaaigeskiedenis? Enige lêer wat buite die toepassingbiblioteek gestoor is, sal op jou toestel bly.',
  ]),
  ar: buildDownloadHistoryStorageOverrides([
    'حذف الملف من الجهاز',
    'هل تريد حذف ملف التنزيل هذا نهائيًا من هذا الجهاز؟ سيبقى إدخال السجل ورابط المصدر.',
    'تعذر حذف الملف الذي تم تنزيله من هذا الجهاز.',
    'لم يعد لهذا التنزيل ملف قابل للحذف في مكتبة التطبيق.',
    'هذا الفيديو مفتوح حاليًا. افتح فيديو آخر قبل حذفه.',
    'حذف الملف والسجل',
    'هل تريد حذف ملف التنزيل هذا نهائيًا وإزالة إدخاله من السجل؟ لا يمكن التراجع عن ذلك.',
    'إزالة من السجل',
    'هل تريد إزالة هذا العنصر من سجل التنزيلات؟ سيبقى أي ملف محفوظ خارج مكتبة التطبيق على جهازك.',
  ]),
  bn: buildDownloadHistoryStorageOverrides([
    'ডিভাইস থেকে ফাইল মুছুন',
    'এই ডাউনলোড করা ফাইলটি এই ডিভাইস থেকে স্থায়ীভাবে মুছবেন? ইতিহাসের এন্ট্রি ও উৎসের লিঙ্ক থাকবে।',
    'এই ডিভাইস থেকে ডাউনলোড করা ফাইলটি মোছা যায়নি।',
    'এই ডাউনলোডটির অ্যাপ লাইব্রেরিতে আর মোছার মতো কোনো ফাইল নেই।',
    'এই ভিডিওটি বর্তমানে খোলা আছে। মোছার আগে অন্য একটি ভিডিও খুলুন।',
    'ফাইল ও ইতিহাস মুছুন',
    'এই ডাউনলোড করা ফাইলটি স্থায়ীভাবে মুছে ইতিহাসের এন্ট্রিটিও সরাবেন? এটি আর ফিরিয়ে আনা যাবে না।',
    'ইতিহাস থেকে সরান',
    'এই আইটেমটি ডাউনলোড ইতিহাস থেকে সরাবেন? অ্যাপ লাইব্রেরির বাইরে সংরক্ষিত যেকোনো ফাইল আপনার ডিভাইসে থাকবে।',
  ]),
  cs: buildDownloadHistoryStorageOverrides([
    'Odstranit soubor ze zařízení',
    'Trvale odstranit tento stažený soubor ze zařízení? Záznam v historii a odkaz na zdroj zůstanou zachovány.',
    'Stažený soubor se ze zařízení nepodařilo odstranit.',
    'Toto stažení již nemá soubor v knihovně aplikace, který lze odstranit.',
    'Toto video je právě otevřené. Před odstraněním otevřete jiné video.',
    'Odstranit soubor i historii',
    'Trvale odstranit tento stažený soubor i jeho záznam v historii? Tuto akci nelze vrátit zpět.',
    'Odebrat z historie',
    'Odebrat tuto položku z historie stahování? Soubor uložený mimo knihovnu aplikace zůstane v zařízení.',
  ]),
  da: buildDownloadHistoryStorageOverrides([
    'Slet fil fra enheden',
    'Vil du slette denne downloadede fil permanent fra enheden? Historikposten og kildelinket bevares.',
    'Den downloadede fil kunne ikke slettes fra enheden.',
    'Denne download har ikke længere en fil i appbiblioteket, der kan slettes.',
    'Denne video er åben. Åbn en anden video, før du sletter den.',
    'Slet fil og historik',
    'Vil du slette denne downloadede fil permanent og fjerne historikposten? Dette kan ikke fortrydes.',
    'Fjern fra historik',
    'Vil du fjerne dette element fra downloadhistorikken? Filer, der er gemt uden for appbiblioteket, bliver på enheden.',
  ]),
  de: buildDownloadHistoryStorageOverrides([
    'Datei vom Gerät löschen',
    'Diese heruntergeladene Datei dauerhaft vom Gerät löschen? Verlaufseintrag und Quelllink bleiben erhalten.',
    'Die heruntergeladene Datei konnte nicht vom Gerät gelöscht werden.',
    'Für diesen Download gibt es keine löschbare Datei mehr in der App-Mediathek.',
    'Dieses Video ist derzeit geöffnet. Öffne vor dem Löschen ein anderes Video.',
    'Datei und Verlauf löschen',
    'Diese heruntergeladene Datei und ihren Verlaufseintrag dauerhaft löschen? Dies kann nicht rückgängig gemacht werden.',
    'Aus Verlauf entfernen',
    'Diesen Eintrag aus dem Downloadverlauf entfernen? Außerhalb der App-Mediathek gespeicherte Dateien bleiben auf dem Gerät.',
  ]),
  el: buildDownloadHistoryStorageOverrides([
    'Διαγραφή αρχείου από τη συσκευή',
    'Να διαγραφεί οριστικά αυτό το ληφθέν αρχείο από τη συσκευή; Η καταχώριση ιστορικού και ο σύνδεσμος πηγής θα παραμείνουν.',
    'Δεν ήταν δυνατή η διαγραφή του ληφθέντος αρχείου από τη συσκευή.',
    'Αυτή η λήψη δεν διαθέτει πλέον διαγράψιμο αρχείο στη βιβλιοθήκη της εφαρμογής.',
    'Αυτό το βίντεο είναι ανοιχτό. Ανοίξτε άλλο βίντεο πριν το διαγράψετε.',
    'Διαγραφή αρχείου και ιστορικού',
    'Να διαγραφεί οριστικά αυτό το ληφθέν αρχείο και η καταχώριση ιστορικού του; Η ενέργεια δεν αναιρείται.',
    'Αφαίρεση από το ιστορικό',
    'Να αφαιρεθεί αυτό το στοιχείο από το ιστορικό λήψεων; Κάθε αρχείο που αποθηκεύτηκε εκτός της βιβλιοθήκης εφαρμογής θα παραμείνει στη συσκευή.',
  ]),
  es: buildDownloadHistoryStorageOverrides([
    'Eliminar archivo del dispositivo',
    '¿Eliminar permanentemente este archivo descargado del dispositivo? La entrada del historial y el enlace de origen se conservarán.',
    'No se pudo eliminar el archivo descargado del dispositivo.',
    'Esta descarga ya no tiene un archivo eliminable en la biblioteca de la aplicación.',
    'Este video está abierto. Abre otro video antes de eliminarlo.',
    'Eliminar archivo e historial',
    '¿Eliminar permanentemente este archivo descargado y su entrada del historial? Esta acción no se puede deshacer.',
    'Quitar del historial',
    '¿Quitar este elemento del historial de descargas? Los archivos guardados fuera de la biblioteca de la aplicación permanecerán en el dispositivo.',
  ]),
  fa: buildDownloadHistoryStorageOverrides([
    'حذف فایل از دستگاه',
    'این فایل دانلودشده برای همیشه از این دستگاه حذف شود؟ ورودی سابقه و پیوند منبع باقی می‌مانند.',
    'فایل دانلودشده از این دستگاه حذف نشد.',
    'این دانلود دیگر فایل قابل حذفی در کتابخانه برنامه ندارد.',
    'این ویدیو اکنون باز است. پیش از حذف، ویدیوی دیگری را باز کنید.',
    'حذف فایل و سابقه',
    'این فایل دانلودشده و ورودی سابقه آن برای همیشه حذف شوند؟ این کار قابل بازگشت نیست.',
    'حذف از سابقه',
    'این مورد از سابقه دانلود حذف شود؟ فایل‌های ذخیره‌شده بیرون از کتابخانه برنامه روی دستگاه باقی می‌مانند.',
  ]),
  fi: buildDownloadHistoryStorageOverrides([
    'Poista tiedosto laitteelta',
    'Poistetaanko tämä ladattu tiedosto pysyvästi laitteelta? Historiatieto ja lähdelinkki säilyvät.',
    'Ladattua tiedostoa ei voitu poistaa laitteelta.',
    'Tällä latauksella ei enää ole poistettavaa tiedostoa sovelluskirjastossa.',
    'Tämä video on parhaillaan avoinna. Avaa toinen video ennen poistamista.',
    'Poista tiedosto ja historia',
    'Poistetaanko tämä ladattu tiedosto ja sen historiatieto pysyvästi? Toimintoa ei voi kumota.',
    'Poista historiasta',
    'Poistetaanko tämä kohde lataushistoriasta? Sovelluskirjaston ulkopuolelle tallennetut tiedostot säilyvät laitteella.',
  ]),
  fr: buildDownloadHistoryStorageOverrides([
    'Supprimer le fichier de l’appareil',
    'Supprimer définitivement ce fichier téléchargé de cet appareil ? L’entrée d’historique et le lien source seront conservés.',
    'Impossible de supprimer le fichier téléchargé de cet appareil.',
    'Ce téléchargement ne possède plus de fichier supprimable dans la bibliothèque de l’application.',
    'Cette vidéo est actuellement ouverte. Ouvrez une autre vidéo avant de la supprimer.',
    'Supprimer le fichier et l’historique',
    'Supprimer définitivement ce fichier téléchargé et son entrée d’historique ? Cette action est irréversible.',
    'Retirer de l’historique',
    'Retirer cet élément de l’historique des téléchargements ? Les fichiers enregistrés hors de la bibliothèque de l’application resteront sur l’appareil.',
  ]),
  he: buildDownloadHistoryStorageOverrides([
    'מחיקת הקובץ מהמכשיר',
    'למחוק לצמיתות את הקובץ שהורד מהמכשיר? רשומת ההיסטוריה והקישור למקור יישארו.',
    'לא ניתן למחוק את הקובץ שהורד מהמכשיר.',
    'להורדה הזו כבר אין קובץ שניתן למחוק בספריית היישום.',
    'הסרטון פתוח כעת. יש לפתוח סרטון אחר לפני המחיקה.',
    'מחיקת הקובץ וההיסטוריה',
    'למחוק לצמיתות את הקובץ שהורד ואת רשומת ההיסטוריה שלו? לא ניתן לבטל פעולה זו.',
    'הסרה מההיסטוריה',
    'להסיר פריט זה מהיסטוריית ההורדות? קבצים שנשמרו מחוץ לספריית היישום יישארו במכשיר.',
  ]),
  hi: buildDownloadHistoryStorageOverrides([
    'डिवाइस से फ़ाइल मिटाएँ',
    'इस डाउनलोड की गई फ़ाइल को डिवाइस से हमेशा के लिए मिटाएँ? इतिहास प्रविष्टि और स्रोत लिंक बने रहेंगे।',
    'डाउनलोड की गई फ़ाइल को डिवाइस से मिटाया नहीं जा सका।',
    'इस डाउनलोड की ऐप लाइब्रेरी में अब मिटाने योग्य फ़ाइल नहीं है।',
    'यह वीडियो अभी खुला है। इसे मिटाने से पहले कोई दूसरा वीडियो खोलें।',
    'फ़ाइल और इतिहास मिटाएँ',
    'डाउनलोड की गई फ़ाइल और उसकी इतिहास प्रविष्टि को हमेशा के लिए मिटाएँ? इसे वापस नहीं किया जा सकता।',
    'इतिहास से हटाएँ',
    'इस आइटम को डाउनलोड इतिहास से हटाएँ? ऐप लाइब्रेरी के बाहर सहेजी गई फ़ाइलें आपके डिवाइस पर रहेंगी।',
  ]),
  hu: buildDownloadHistoryStorageOverrides([
    'Fájl törlése az eszközről',
    'Végleg törli ezt a letöltött fájlt az eszközről? Az előzménybejegyzés és a forráshivatkozás megmarad.',
    'A letöltött fájlt nem sikerült törölni az eszközről.',
    'Ehhez a letöltéshez már nem tartozik törölhető fájl az alkalmazás könyvtárában.',
    'Ez a videó jelenleg meg van nyitva. Törlés előtt nyisson meg egy másik videót.',
    'Fájl és előzmény törlése',
    'Végleg törli ezt a letöltött fájlt és az előzménybejegyzését? Ez nem vonható vissza.',
    'Eltávolítás az előzményekből',
    'Eltávolítja ezt az elemet a letöltési előzményekből? Az alkalmazás könyvtárán kívül mentett fájlok az eszközön maradnak.',
  ]),
  id: buildDownloadHistoryStorageOverrides([
    'Hapus file dari perangkat',
    'Hapus permanen file unduhan ini dari perangkat? Entri riwayat dan tautan sumber akan tetap ada.',
    'File unduhan tidak dapat dihapus dari perangkat.',
    'Unduhan ini tidak lagi memiliki file yang dapat dihapus di pustaka aplikasi.',
    'Video ini sedang dibuka. Buka video lain sebelum menghapusnya.',
    'Hapus file dan riwayat',
    'Hapus permanen file unduhan ini beserta entri riwayatnya? Tindakan ini tidak dapat dibatalkan.',
    'Hapus dari riwayat',
    'Hapus item ini dari riwayat unduhan? File yang disimpan di luar pustaka aplikasi akan tetap ada di perangkat.',
  ]),
  it: buildDownloadHistoryStorageOverrides([
    'Elimina file dal dispositivo',
    'Eliminare definitivamente questo file scaricato dal dispositivo? La voce della cronologia e il link di origine resteranno disponibili.',
    'Impossibile eliminare il file scaricato dal dispositivo.',
    'Questo download non ha più un file eliminabile nella libreria dell’app.',
    'Questo video è attualmente aperto. Apri un altro video prima di eliminarlo.',
    'Elimina file e cronologia',
    'Eliminare definitivamente questo file scaricato e la relativa voce della cronologia? L’azione non può essere annullata.',
    'Rimuovi dalla cronologia',
    'Rimuovere questo elemento dalla cronologia dei download? I file salvati fuori dalla libreria dell’app resteranno sul dispositivo.',
  ]),
  ja: buildDownloadHistoryStorageOverrides([
    'デバイスからファイルを削除',
    'このダウンロード済みファイルをデバイスから完全に削除しますか？履歴項目と元のリンクは残ります。',
    'ダウンロード済みファイルをデバイスから削除できませんでした。',
    'このダウンロードには、アプリライブラリ内に削除できるファイルがありません。',
    'この動画は現在開いています。削除する前に別の動画を開いてください。',
    'ファイルと履歴を削除',
    'このダウンロード済みファイルと履歴項目を完全に削除しますか？この操作は元に戻せません。',
    '履歴から削除',
    'この項目をダウンロード履歴から削除しますか？アプリライブラリ外に保存したファイルはデバイスに残ります。',
  ]),
  ko: buildDownloadHistoryStorageOverrides([
    '기기에서 파일 삭제',
    '이 다운로드 파일을 기기에서 영구적으로 삭제할까요? 기록 항목과 원본 링크는 유지됩니다.',
    '다운로드 파일을 기기에서 삭제하지 못했습니다.',
    '이 다운로드에는 앱 라이브러리에서 삭제할 수 있는 파일이 더 이상 없습니다.',
    '이 동영상은 현재 열려 있습니다. 삭제하기 전에 다른 동영상을 여세요.',
    '파일 및 기록 삭제',
    '이 다운로드 파일과 기록 항목을 영구적으로 삭제할까요? 이 작업은 취소할 수 없습니다.',
    '기록에서 제거',
    '이 항목을 다운로드 기록에서 제거할까요? 앱 라이브러리 외부에 저장된 파일은 기기에 남습니다.',
  ]),
  mr: buildDownloadHistoryStorageOverrides([
    'डिव्हाइसवरून फाइल हटवा',
    'ही डाउनलोड केलेली फाइल डिव्हाइसवरून कायमची हटवायची? इतिहास नोंद आणि स्रोत दुवा कायम राहतील.',
    'डाउनलोड केलेली फाइल डिव्हाइसवरून हटवता आली नाही.',
    'या डाउनलोडसाठी ॲप लायब्ररीमध्ये हटवता येणारी फाइल आता उपलब्ध नाही.',
    'हा व्हिडिओ सध्या उघडा आहे. तो हटवण्यापूर्वी दुसरा व्हिडिओ उघडा.',
    'फाइल आणि इतिहास हटवा',
    'ही डाउनलोड केलेली फाइल आणि तिची इतिहास नोंद कायमची हटवायची? ही क्रिया पूर्ववत करता येणार नाही.',
    'इतिहासातून काढा',
    'हा आयटम डाउनलोड इतिहासातून काढायचा? ॲप लायब्ररीबाहेर जतन केलेल्या फाइल्स डिव्हाइसवर राहतील.',
  ]),
  ms: buildDownloadHistoryStorageOverrides([
    'Padam fail daripada peranti',
    'Padam fail yang dimuat turun ini secara kekal daripada peranti? Entri sejarah dan pautan sumber akan dikekalkan.',
    'Fail yang dimuat turun tidak dapat dipadam daripada peranti.',
    'Muat turun ini tidak lagi mempunyai fail yang boleh dipadam dalam pustaka aplikasi.',
    'Video ini sedang dibuka. Buka video lain sebelum memadamkannya.',
    'Padam fail dan sejarah',
    'Padam fail yang dimuat turun ini serta entri sejarahnya secara kekal? Tindakan ini tidak boleh dibuat asal.',
    'Alih keluar daripada sejarah',
    'Alih keluar item ini daripada sejarah muat turun? Fail yang disimpan di luar pustaka aplikasi akan kekal pada peranti.',
  ]),
  nl: buildDownloadHistoryStorageOverrides([
    'Bestand van apparaat verwijderen',
    'Dit gedownloade bestand permanent van het apparaat verwijderen? De geschiedenisvermelding en bronlink blijven behouden.',
    'Het gedownloade bestand kon niet van het apparaat worden verwijderd.',
    'Deze download heeft geen verwijderbaar bestand meer in de appbibliotheek.',
    'Deze video is momenteel geopend. Open een andere video voordat je hem verwijdert.',
    'Bestand en geschiedenis verwijderen',
    'Dit gedownloade bestand en de geschiedenisvermelding permanent verwijderen? Dit kan niet ongedaan worden gemaakt.',
    'Uit geschiedenis verwijderen',
    'Dit item uit de downloadgeschiedenis verwijderen? Bestanden die buiten de appbibliotheek zijn opgeslagen, blijven op het apparaat staan.',
  ]),
  no: buildDownloadHistoryStorageOverrides([
    'Slett fil fra enheten',
    'Vil du slette denne nedlastede filen permanent fra enheten? Historikkoppføringen og kildelenken beholdes.',
    'Den nedlastede filen kunne ikke slettes fra enheten.',
    'Denne nedlastingen har ikke lenger en fil i appbiblioteket som kan slettes.',
    'Denne videoen er åpen. Åpne en annen video før du sletter den.',
    'Slett fil og historikk',
    'Vil du slette denne nedlastede filen og historikkoppføringen permanent? Dette kan ikke angres.',
    'Fjern fra historikk',
    'Vil du fjerne dette elementet fra nedlastingshistorikken? Filer lagret utenfor appbiblioteket blir værende på enheten.',
  ]),
  pl: buildDownloadHistoryStorageOverrides([
    'Usuń plik z urządzenia',
    'Trwale usunąć pobrany plik z urządzenia? Wpis historii i link źródłowy pozostaną.',
    'Nie udało się usunąć pobranego pliku z urządzenia.',
    'To pobranie nie ma już pliku możliwego do usunięcia w bibliotece aplikacji.',
    'Ten film jest obecnie otwarty. Przed usunięciem otwórz inny film.',
    'Usuń plik i historię',
    'Trwale usunąć pobrany plik i jego wpis historii? Tej czynności nie można cofnąć.',
    'Usuń z historii',
    'Usunąć ten element z historii pobierania? Pliki zapisane poza biblioteką aplikacji pozostaną na urządzeniu.',
  ]),
  pt: buildDownloadHistoryStorageOverrides([
    'Excluir arquivo do dispositivo',
    'Excluir permanentemente este arquivo baixado do dispositivo? A entrada do histórico e o link da fonte serão mantidos.',
    'Não foi possível excluir o arquivo baixado do dispositivo.',
    'Este download não tem mais um arquivo que possa ser excluído na biblioteca do aplicativo.',
    'Este vídeo está aberto. Abra outro vídeo antes de excluí-lo.',
    'Excluir arquivo e histórico',
    'Excluir permanentemente este arquivo baixado e a entrada do histórico? Esta ação não pode ser desfeita.',
    'Remover do histórico',
    'Remover este item do histórico de downloads? Arquivos salvos fora da biblioteca do aplicativo permanecerão no dispositivo.',
  ]),
  ro: buildDownloadHistoryStorageOverrides([
    'Șterge fișierul de pe dispozitiv',
    'Ștergeți definitiv acest fișier descărcat de pe dispozitiv? Intrarea din istoric și linkul sursă vor rămâne.',
    'Fișierul descărcat nu a putut fi șters de pe dispozitiv.',
    'Această descărcare nu mai are un fișier care poate fi șters în biblioteca aplicației.',
    'Acest videoclip este deschis. Deschideți alt videoclip înainte de a-l șterge.',
    'Șterge fișierul și istoricul',
    'Ștergeți definitiv acest fișier descărcat și intrarea sa din istoric? Acțiunea nu poate fi anulată.',
    'Elimină din istoric',
    'Eliminați acest element din istoricul descărcărilor? Fișierele salvate în afara bibliotecii aplicației vor rămâne pe dispozitiv.',
  ]),
  ru: buildDownloadHistoryStorageOverrides([
    'Удалить файл с устройства',
    'Навсегда удалить этот загруженный файл с устройства? Запись в истории и ссылка на источник сохранятся.',
    'Не удалось удалить загруженный файл с устройства.',
    'У этой загрузки больше нет файла в библиотеке приложения, который можно удалить.',
    'Это видео сейчас открыто. Перед удалением откройте другое видео.',
    'Удалить файл и историю',
    'Навсегда удалить этот загруженный файл и запись о нём из истории? Это действие нельзя отменить.',
    'Удалить из истории',
    'Удалить этот элемент из истории загрузок? Файлы, сохранённые вне библиотеки приложения, останутся на устройстве.',
  ]),
  sv: buildDownloadHistoryStorageOverrides([
    'Ta bort filen från enheten',
    'Vill du ta bort den här nedladdade filen permanent från enheten? Historikposten och källänken behålls.',
    'Det gick inte att ta bort den nedladdade filen från enheten.',
    'Den här nedladdningen har inte längre någon fil i appbiblioteket som kan tas bort.',
    'Den här videon är öppen. Öppna en annan video innan du tar bort den.',
    'Ta bort fil och historik',
    'Vill du ta bort den här nedladdade filen och historikposten permanent? Detta kan inte ångras.',
    'Ta bort från historiken',
    'Vill du ta bort objektet från nedladdningshistoriken? Filer som sparats utanför appbiblioteket blir kvar på enheten.',
  ]),
  sw: buildDownloadHistoryStorageOverrides([
    'Futa faili kwenye kifaa',
    'Ufute kabisa faili hii iliyopakuliwa kwenye kifaa? Ingizo la historia na kiungo cha chanzo vitabaki.',
    'Faili iliyopakuliwa haikuweza kufutwa kwenye kifaa.',
    'Upakuaji huu hauna tena faili inayoweza kufutwa katika maktaba ya programu.',
    'Video hii imefunguliwa kwa sasa. Fungua video nyingine kabla ya kuifuta.',
    'Futa faili na historia',
    'Ufute kabisa faili hii iliyopakuliwa na ingizo lake la historia? Kitendo hiki hakiwezi kutenduliwa.',
    'Ondoa kwenye historia',
    'Uondoe kipengee hiki kwenye historia ya vipakuliwa? Faili zilizohifadhiwa nje ya maktaba ya programu zitabaki kwenye kifaa.',
  ]),
  ta: buildDownloadHistoryStorageOverrides([
    'சாதனத்திலிருந்து கோப்பை நீக்கு',
    'பதிவிறக்கிய இந்தக் கோப்பை சாதனத்திலிருந்து நிரந்தரமாக நீக்கவா? வரலாற்றுப் பதிவும் மூல இணைப்பும் இருக்கும்.',
    'பதிவிறக்கிய கோப்பை சாதனத்திலிருந்து நீக்க முடியவில்லை.',
    'இந்தப் பதிவிறக்கத்திற்கு பயன்பாட்டு நூலகத்தில் நீக்கக்கூடிய கோப்பு இனி இல்லை.',
    'இந்த வீடியோ தற்போது திறந்துள்ளது. அதை நீக்குவதற்கு முன் வேறு வீடியோவைத் திறக்கவும்.',
    'கோப்பையும் வரலாற்றையும் நீக்கு',
    'பதிவிறக்கிய இந்தக் கோப்பையும் அதன் வரலாற்றுப் பதிவையும் நிரந்தரமாக நீக்கவா? இதை மீளமைக்க முடியாது.',
    'வரலாற்றிலிருந்து அகற்று',
    'இந்த உருப்படியைப் பதிவிறக்க வரலாற்றிலிருந்து அகற்றவா? பயன்பாட்டு நூலகத்திற்கு வெளியே சேமித்த கோப்புகள் சாதனத்தில் இருக்கும்.',
  ]),
  te: buildDownloadHistoryStorageOverrides([
    'పరికరం నుండి ఫైల్‌ను తొలగించండి',
    'డౌన్‌లోడ్ చేసిన ఈ ఫైల్‌ను పరికరం నుండి శాశ్వతంగా తొలగించాలా? చరిత్ర నమోదు మరియు మూల లింక్ అలాగే ఉంటాయి.',
    'డౌన్‌లోడ్ చేసిన ఫైల్‌ను పరికరం నుండి తొలగించలేకపోయాము.',
    'ఈ డౌన్‌లోడ్‌కు యాప్ లైబ్రరీలో తొలగించగల ఫైల్ ఇక లేదు.',
    'ఈ వీడియో ప్రస్తుతం తెరిచి ఉంది. తొలగించే ముందు మరో వీడియోను తెరవండి.',
    'ఫైల్ మరియు చరిత్రను తొలగించండి',
    'డౌన్‌లోడ్ చేసిన ఈ ఫైల్‌ను మరియు దాని చరిత్ర నమోదును శాశ్వతంగా తొలగించాలా? దీన్ని తిరిగి పొందలేరు.',
    'చరిత్ర నుండి తీసివేయండి',
    'ఈ అంశాన్ని డౌన్‌లోడ్ చరిత్ర నుండి తీసివేయాలా? యాప్ లైబ్రరీ వెలుపల సేవ్ చేసిన ఫైళ్లు పరికరంలోనే ఉంటాయి.',
  ]),
  th: buildDownloadHistoryStorageOverrides([
    'ลบไฟล์ออกจากอุปกรณ์',
    'ลบไฟล์ที่ดาวน์โหลดนี้ออกจากอุปกรณ์อย่างถาวรหรือไม่ รายการประวัติและลิงก์ต้นทางจะยังคงอยู่',
    'ไม่สามารถลบไฟล์ที่ดาวน์โหลดออกจากอุปกรณ์ได้',
    'รายการดาวน์โหลดนี้ไม่มีไฟล์ในคลังของแอปที่สามารถลบได้อีกแล้ว',
    'วิดีโอนี้กำลังเปิดอยู่ โปรดเปิดวิดีโออื่นก่อนลบ',
    'ลบไฟล์และประวัติ',
    'ลบไฟล์ที่ดาวน์โหลดนี้และรายการประวัติอย่างถาวรหรือไม่ การดำเนินการนี้ย้อนกลับไม่ได้',
    'นำออกจากประวัติ',
    'นำรายการนี้ออกจากประวัติการดาวน์โหลดหรือไม่ ไฟล์ที่บันทึกไว้นอกคลังของแอปจะยังคงอยู่ในอุปกรณ์',
  ]),
  tl: buildDownloadHistoryStorageOverrides([
    'I-delete ang file sa device',
    'Permanenteng i-delete ang na-download na file na ito sa device? Mananatili ang entry sa history at source link.',
    'Hindi ma-delete sa device ang na-download na file.',
    'Wala nang file sa app library ang download na ito na maaaring i-delete.',
    'Kasalukuyang bukas ang video na ito. Magbukas ng ibang video bago ito i-delete.',
    'I-delete ang file at history',
    'Permanenteng i-delete ang na-download na file na ito at ang entry nito sa history? Hindi ito maaaring i-undo.',
    'Alisin sa history',
    'Alisin ang item na ito sa download history? Mananatili sa device ang mga file na naka-save sa labas ng app library.',
  ]),
  tr: buildDownloadHistoryStorageOverrides([
    'Dosyayı cihazdan sil',
    'İndirilen bu dosya cihazdan kalıcı olarak silinsin mi? Geçmiş kaydı ve kaynak bağlantısı kalır.',
    'İndirilen dosya cihazdan silinemedi.',
    'Bu indirmede artık uygulama kitaplığında silinebilecek bir dosya yok.',
    'Bu video şu anda açık. Silmeden önce başka bir video açın.',
    'Dosyayı ve geçmişi sil',
    'İndirilen bu dosya ve geçmiş kaydı kalıcı olarak silinsin mi? Bu işlem geri alınamaz.',
    'Geçmişten kaldır',
    'Bu öğe indirme geçmişinden kaldırılsın mı? Uygulama kitaplığı dışında kaydedilen dosyalar cihazda kalır.',
  ]),
  uk: buildDownloadHistoryStorageOverrides([
    'Видалити файл із пристрою',
    'Назавжди видалити цей завантажений файл із пристрою? Запис в історії та посилання на джерело залишаться.',
    'Не вдалося видалити завантажений файл із пристрою.',
    'Для цього завантаження більше немає файлу в бібліотеці застосунку, який можна видалити.',
    'Це відео зараз відкрите. Перед видаленням відкрийте інше відео.',
    'Видалити файл та історію',
    'Назавжди видалити цей завантажений файл і запис про нього з історії? Цю дію не можна скасувати.',
    'Видалити з історії',
    'Видалити цей елемент з історії завантажень? Файли, збережені поза бібліотекою застосунку, залишаться на пристрої.',
  ]),
  ur: buildDownloadHistoryStorageOverrides([
    'ڈیوائس سے فائل حذف کریں',
    'اس ڈاؤن لوڈ شدہ فائل کو ڈیوائس سے مستقل طور پر حذف کریں؟ تاریخ کا اندراج اور ماخذ لنک باقی رہیں گے۔',
    'ڈاؤن لوڈ شدہ فائل کو ڈیوائس سے حذف نہیں کیا جا سکا۔',
    'اس ڈاؤن لوڈ کے لیے ایپ لائبریری میں اب کوئی قابلِ حذف فائل موجود نہیں۔',
    'یہ ویڈیو اس وقت کھلی ہے۔ حذف کرنے سے پہلے کوئی دوسری ویڈیو کھولیں۔',
    'فائل اور تاریخ حذف کریں',
    'اس ڈاؤن لوڈ شدہ فائل اور اس کے تاریخی اندراج کو مستقل طور پر حذف کریں؟ یہ عمل واپس نہیں ہو سکتا۔',
    'تاریخ سے ہٹائیں',
    'اس آئٹم کو ڈاؤن لوڈ تاریخ سے ہٹائیں؟ ایپ لائبریری سے باہر محفوظ فائلیں ڈیوائس پر رہیں گی۔',
  ]),
  vi: buildDownloadHistoryStorageOverrides([
    'Xóa tệp khỏi thiết bị',
    'Xóa vĩnh viễn tệp đã tải xuống này khỏi thiết bị? Mục lịch sử và liên kết nguồn sẽ được giữ lại.',
    'Không thể xóa tệp đã tải xuống khỏi thiết bị.',
    'Bản tải xuống này không còn tệp có thể xóa trong thư viện ứng dụng.',
    'Video này đang được mở. Hãy mở video khác trước khi xóa.',
    'Xóa tệp và lịch sử',
    'Xóa vĩnh viễn tệp đã tải xuống này và mục lịch sử của tệp? Không thể hoàn tác thao tác này.',
    'Xóa khỏi lịch sử',
    'Xóa mục này khỏi lịch sử tải xuống? Các tệp lưu ngoài thư viện ứng dụng sẽ vẫn còn trên thiết bị.',
  ]),
  'zh-CN': buildDownloadHistoryStorageOverrides([
    '从设备中删除文件',
    '要从此设备永久删除这个已下载文件吗？历史记录和来源链接将保留。',
    '无法从设备中删除已下载文件。',
    '此下载在应用媒体库中已没有可删除的文件。',
    '此视频当前已打开。请先打开其他视频再删除。',
    '删除文件和历史记录',
    '要永久删除这个已下载文件及其历史记录吗？此操作无法撤销。',
    '从历史记录中移除',
    '要从下载历史记录中移除此项目吗？保存在应用媒体库之外的文件将留在设备上。',
  ]),
  'zh-TW': buildDownloadHistoryStorageOverrides([
    '從裝置刪除檔案',
    '要從此裝置永久刪除這個已下載檔案嗎？歷史記錄和來源連結將保留。',
    '無法從裝置刪除已下載檔案。',
    '此下載在應用程式媒體庫中已沒有可刪除的檔案。',
    '此影片目前已開啟。請先開啟其他影片再刪除。',
    '刪除檔案和歷史記錄',
    '要永久刪除這個已下載檔案及其歷史記錄嗎？此操作無法還原。',
    '從歷史記錄中移除',
    '要從下載歷史記錄中移除此項目嗎？儲存在應用程式媒體庫之外的檔案將保留在裝置上。',
  ]),
};
...
export default Object.fromEntries(
  Object.entries(baseOverrides).map(([langCode, overrides]) => [
    langCode,
    {
      ...
      ...(downloadHistoryStorageOverrides[langCode] ?? {}),
    },
  ])
);
