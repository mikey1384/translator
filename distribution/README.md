...
- **WinGet:** metadata and immutable-artifact verification pass. External
  submission remains gated on the clean Windows x64 `/S` install, reinstall,
  upgrade, and uninstall smoke test described above.
